...
const sections = {
  Inventory: ["Virtual Freezers", "Consumables", "Orders", "Alerts"],
  Notebook: ["Experiments", "Protocols", "Version Control", "Reports"],
  Platform: ["Genemod AI", "Security", "Integrations", "Equipment"],
};
